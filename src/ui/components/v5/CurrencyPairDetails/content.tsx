...
import { ExchangeRate, ExchangeRateHistoryItem, Market, Portfolio } from '../../../types/v5';
                ...
                <Callout className="CurrencyPairDetails__action">
                    ...
                    <section className="CurrencyPairDetails__controls">
                        <FormGroup
                            ...
                            labelFor="buy-input"
                        >
                            <NumericInput fill={false} id="buy-input" min={0} value={currentBuyAmount} onValueChange={setCurrentBuyAmount} />
                        </FormGroup>
