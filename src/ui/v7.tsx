...
import { CurrencyPairDetails } from './components/v6/CurrencyPairDetails';
import { PortfolioPreview } from './components/v4/PortfolioPreview';
import { OrdersHistory } from './components/v7/OrdersHistory';

import { CurrencyPair, Market, Portfolio } from './types/v7';
